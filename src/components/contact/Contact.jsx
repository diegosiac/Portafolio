    ...
    <article className='contact__Container'>
        ...
        <div className='contact__links'>
          <div className='contact__Icons'>
            <a href='https://github.com/DiegoADC' target='_blank'>
              <GitHubIcon/>
              <span className='contact__Social'>Github</span>
            </a>
            <a href='https://www.linkedin.com/in/diegocruzadc/' target='_blank'>
              <LinkedInIcon/>
          ...
          <div className='contact__email'> 
            <CopyToClipboard text={emai}>
              <button onClick={isCopy} className='email__button' onMouseEnter={isOnHover} onMouseLeave={notOnHover}>diegoADC@gmail.com</button> 
            </CopyToClipboard>
